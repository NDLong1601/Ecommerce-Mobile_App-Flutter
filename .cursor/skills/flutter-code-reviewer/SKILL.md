...
2. **Review by area** 
    - Apply architecture rules from [references/architecture_rules.md](references/architecture_rules.md)
...
- Verify proper file location and layer separation
- Check for cross-module dependency violations
- Verify proper use of state management (Cubit/Bloc)
- Check for proper dependency injection with GetIt
- Validate import rules for each architecture layer